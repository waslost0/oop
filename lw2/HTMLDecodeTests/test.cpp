...
TEST(Decode, HtmlDecode_test_cat)
{
...
TEST(Decode, HtmlDecode_test_double_ampersand)
{
	std::string strIn = "&&amp;";
	std::string strOut = "&&";
	EXPECT_EQ(HtmlDecode(strIn), strOut);
...
TEST(Decode, HtmlDecode_test_multi_ampersand)
{
...
TEST(Decode, HtmlDecode_test_html)
{
...
TEST(Decode, HtmlDecode_test_html2)
{
